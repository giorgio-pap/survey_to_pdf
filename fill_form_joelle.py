...
Adapted on Tue Feb 9 16:37 2021
Fixed leading zero problem with IBAN;
@author: Joelle Schroen

Adapted on Wed Feb 10 11:09
Annotation set as not editable to fix viewing problem;
Consequently, not possible to concatinate the separate files (first page always printed multiple times)
@author: Joelle Schroen
            ...
            if annotation[SUBTYPE_KEY] == WIDGET_SUBTYPE_KEY:
                if annotation[ANNOT_FIELD_KEY]:
                    ...
                    if key in data_dict.keys():
                        annotation.update(pdfrw.PdfDict(AP=data_dict[key],Ff=1,V='{}'.format(data_dict[key]))) 
